          ...
          <div className="grid gap-3.5">
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4 mb-2">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="font-bold text-lg text-blue-900 dark:text-blue-100">Visual Guide Available</div>
              </div>
              <div className="text-blue-800 dark:text-blue-200 mb-3">
                Check out our comprehensive visual guide with ASCII diagrams showing ventilation system types, home layouts, and Ecobee wiring patterns.
              </div>
              <Link
                to="/tools/whole-house-ventilation-ecobee-guide"
