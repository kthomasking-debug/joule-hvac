...
export const routes = [
  ...
  },
  {
    ...
    inMobileNav: false,
    inPrimaryNav: false,
    description: "7-day cost forecast - redirects to /analysis/weekly",
  },
  {
    path: "/monthly-budget",
    name: "Budget",
    ...
    inMobileNav: false,
    inPrimaryNav: false,
    description: "Monthly budget planning - redirects to /analysis/monthly",
  },
  {
    path: "/air-quality",
    name: "Air Quality",
  ...
  {
    path: "/tools/wellness",
    name: "Wellness Hub (Legacy)",
    label: "Wellness Hub",
    icon: Heart,
    Component: () => { return <Navigate to="/wellness" replace />; },
    showInNav: false,
    inMobileNav: false,
    inPrimaryNav: false,
    description: "Legacy redirect to the dedicated Wellness Hub.",
  },
  {
    path: "/tools/daily-calorie-intake",
    name: "Daily Calorie Intake Tool (Legacy)",
    label: "Daily Calorie Intake Tool",
    icon: Scale,
    Component: () => { return <Navigate to="/wellness/daily-calorie-intake" replace />; },
    showInNav: false,
    inMobileNav: false,
    inPrimaryNav: false,
    description: "Legacy redirect to Wellness Hub route.",
  },
  {
    path: "/tools/caffeine-tracker",
    name: "Caffeine Tracker (Legacy)",
    label: "Caffeine Tracker",
    icon: Coffee,
    Component: () => { return <Navigate to="/wellness/caffeine-tracker" replace />; },
    showInNav: false,
    inMobileNav: false,
    inPrimaryNav: false,
    description: "Legacy redirect to Wellness Hub route.",
  },
  {
    ...
    name: "Clonazepam Tracker (Legacy)",
    label: "Clonazepam Tracker",
    icon: Pill,
    Component: () => { return <Navigate to="/wellness/clonazepam-tracker" replace />; },
    showInNav: false,
    inMobileNav: false,
    inPrimaryNav: false,
    description: "Legacy redirect to Wellness Hub route.",
  },
  {
    ...
    name: "Vilazodone Tracker (Legacy)",
    label: "Vilazodone Tracker",
    icon: Pill,
    Component: () => { return <Navigate to="/wellness/vilazodone-tracker" replace />; },
    showInNav: false,
    inMobileNav: false,
    inPrimaryNav: false,
    description: "Legacy redirect to Wellness Hub route.",
  },
  {
    ...
    name: "Lamotrigine Tracker (Legacy)",
    label: "Lamotrigine Tracker",
    icon: Pill,
    Component: () => { return <Navigate to="/wellness/lamotrigine-tracker" replace />; },
    showInNav: false,
    inMobileNav: false,
    inPrimaryNav: false,
    description: "Legacy redirect to Wellness Hub route.",
  },
  {
    ...
    name: "Doxylamine Tracker (Legacy)",
    label: "Doxylamine Tracker",
    icon: Pill,
    Component: () => { return <Navigate to="/wellness/doxylamine-tracker" replace />; },
    showInNav: false,
    inMobileNav: false,
    inPrimaryNav: false,
    description: "Legacy redirect to Wellness Hub route.",
  },
  {
    ...
    name: "Trazodone Tracker (Legacy)",
    label: "Trazodone Tracker",
    icon: Pill,
    Component: () => { return <Navigate to="/wellness/trazodone-tracker" replace />; },
    showInNav: false,
    inMobileNav: false,
    inPrimaryNav: false,
    description: "Legacy redirect to Wellness Hub route.",
  },
  {
    ...
    name: "Levothyroxine Tracker (Legacy)",
    label: "Levothyroxine Tracker",
    icon: Pill,
    Component: () => { return <Navigate to="/wellness/levothyroxine-tracker" replace />; },
    showInNav: false,
    inMobileNav: false,
    inPrimaryNav: false,
    description: "Legacy redirect to Wellness Hub route.",
  },
  {
    ...
    name: "Medication Visual Models (Legacy)",
    label: "Medication Visual Models",
    icon: Activity,
    Component: () => { return <Navigate to="/wellness/medication-visual-models" replace />; },
    showInNav: false,
    inMobileNav: false,
    inPrimaryNav: false,
    description: "Legacy redirect to Wellness Hub route.",
  },
  {
    ...
    name: "Medication Mix Model (Legacy)",
    label: "Medication Mix Model",
    icon: Activity,
    Component: () => { return <Navigate to="/wellness/medication-mix-model" replace />; },
    showInNav: false,
    inMobileNav: false,
    inPrimaryNav: false,
    description: "Legacy redirect to Wellness Hub route.",
  ...
  },
  {
    ...
    inMobileNav: false,
    inPrimaryNav: false,
    description: "Redirects to /analysis/weekly",
  },
  {
    path: "/optimize",
    name: "Optimizer",
