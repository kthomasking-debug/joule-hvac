...
const TEST_CASES = [
  // === TEMPERATURE SETTING ===
  { input: 'set temperature to 72', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: 'set temp to 72', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: 'set to 72', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: '72 degrees', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: 'make it 72', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: 'change to 72', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: 'set heat to 72', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: 'heat to 72 please', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: 'set the temperature to 72', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: 'can you set it to 72', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: 'please set temperature 72', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: 'set thermostat to 72', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: '72', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: 'set to 68', expected: { action: 'setWinterTemp', value: 68, isCommand: true } },
  { input: 'set to 75', expected: { action: 'setWinterTemp', value: 75, isCommand: true } },
  { input: 'set temperature 70', expected: { action: 'setWinterTemp', value: 70, isCommand: true } },
  { input: 'make it 70 degrees', expected: { action: 'setWinterTemp', value: 70, isCommand: true } },
  { input: 'change temperature to 68', expected: { action: 'setWinterTemp', value: 68, isCommand: true } },
  { input: 'set it to 72 degrees fahrenheit', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: 'set heat 72', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: 'set cool to 74', expected: { action: 'setSummerTemp', value: 74, isCommand: true } },
  { input: 'set AC to 72', expected: { action: 'setSummerTemp', value: 72, isCommand: true } },
  
  // === TEMPERATURE ADJUSTMENT ===
  { input: 'make it warmer', expected: { action: 'increaseTemp', isCommand: true } },
  { input: 'make it cooler', expected: { action: 'decreaseTemp', isCommand: true } },
  { input: 'turn it up', expected: { action: 'increaseTemp', isCommand: true } },
  { input: 'turn it down', expected: { action: 'decreaseTemp', isCommand: true } },
  { input: 'increase temperature', expected: { action: 'increaseTemp', isCommand: true } },
  { input: 'decrease temperature', expected: { action: 'decreaseTemp', isCommand: true } },
  { input: 'increase by 2', expected: { action: 'increaseTemp', value: 2, isCommand: true } },
  { input: 'decrease by 2', expected: { action: 'decreaseTemp', value: 2, isCommand: true } },
  { input: 'turn up by 2', expected: { action: 'increaseTemp', value: 2, isCommand: true } },
  { input: 'turn down by 2', expected: { action: 'decreaseTemp', value: 2, isCommand: true } },
  { input: 'make it 2 degrees warmer', expected: { action: 'increaseTemp', value: 2, isCommand: true } },
  { input: 'make it 2 degrees cooler', expected: { action: 'decreaseTemp', value: 2, isCommand: true } },
  { input: 'bump it up', expected: { action: 'increaseTemp', isCommand: true } },
  { input: 'lower it', expected: { action: 'decreaseTemp', isCommand: true } },
  { input: 'raise the temperature', expected: { action: 'increaseTemp', isCommand: true } },
  { input: 'heat it up by 3 degrees', expected: { action: 'increaseTemp', value: 3, isCommand: true } },
  { input: 'turn it down by 5', expected: { action: 'decreaseTemp', value: 5, isCommand: true } },
  ...
  { input: 'set to auto mode', expected: { action: 'setMode', value: 'auto', isCommand: true } },
  { input: 'switch to heat', expected: { action: 'setMode', value: 'heat', isCommand: true } },
  { input: 'switch to cool', expected: { action: 'setMode', value: 'cool', isCommand: true } },
  ...
  { input: 'cool mode', expected: { action: 'setMode', value: 'cool', isCommand: true } },
  { input: 'auto mode', expected: { action: 'setMode', value: 'auto', isCommand: true } },
  { input: 'turn on heat', expected: { action: 'setMode', value: 'heat', isCommand: true } },
  { input: 'turn on cool', expected: { action: 'setMode', value: 'cool', isCommand: true } },
  { input: 'turn off the system', expected: { action: 'setMode', value: 'off', isCommand: true } },
  { input: 'turn on the system', expected: { action: 'setMode', value: 'heat', isCommand: true } },
  
  // === PRESETS ===
  { input: 'set to sleep mode', expected: { action: 'presetSleep', isCommand: true } },
  { input: 'sleep mode', expected: { action: 'presetSleep', isCommand: true } },
  { input: "I'm going to sleep", expected: { action: 'presetSleep', isCommand: true } },
  { input: 'Goodnight', expected: { action: 'presetSleep', isCommand: true } },
  { input: 'set to away mode', expected: { action: 'presetAway', isCommand: true } },
  { input: 'away mode', expected: { action: 'presetAway', isCommand: true } },
  { input: "I'm leaving", expected: { action: 'presetAway', isCommand: true } },
  { input: 'set to home mode', expected: { action: 'presetHome', isCommand: true } },
  { input: 'home mode', expected: { action: 'presetHome', isCommand: true } },
  { input: "I'm home", expected: { action: 'presetHome', isCommand: true } },
  { input: 'activate away mode', expected: { action: 'presetAway', isCommand: true } },
  { input: 'activate home mode', expected: { action: 'presetHome', isCommand: true } },
  
  // === NAVIGATION ===
  { input: 'show me the forecast', expected: { action: 'navigate', target: 'forecast', isCommand: true } },
  { input: 'open forecast', expected: { action: 'navigate', target: 'forecast', isCommand: true } },
  { input: 'go to forecast', expected: { action: 'navigate', target: 'forecast', isCommand: true } },
  { input: 'open settings', expected: { action: 'navigate', target: 'settings', isCommand: true } },
  { input: 'show settings', expected: { action: 'navigate', target: 'settings', isCommand: true } },
  { input: 'go to settings', expected: { action: 'navigate', target: 'settings', isCommand: true } },
  { input: 'run analyzer', expected: { action: 'navigate', target: 'analyzer', isCommand: true } },
  { input: 'open performance analyzer', expected: { action: 'navigate', target: 'analyzer', isCommand: true } },
  { input: 'open budget planner', expected: { action: 'navigate', target: 'budget', isCommand: true } },
  { input: 'analyze my system', expected: { action: 'navigate', target: 'analyzer', isCommand: true } },
  { input: 'show me the graphs', expected: { action: 'navigate', target: 'analyzer', isCommand: true } },
  
  // === STATUS QUERIES ===
  { input: 'what is my score', expected: { action: 'showScore', isCommand: true } },
  { input: 'my joule score', expected: { action: 'showScore', isCommand: true } },
  { input: 'show my score', expected: { action: 'showScore', isCommand: true } },
  { input: 'system status', expected: { action: 'systemStatus', isCommand: true } },
  { input: 'show system status', expected: { action: 'systemStatus', isCommand: true } },
  { input: 'what is the status', expected: { action: 'systemStatus', isCommand: true } },
  
  // === CALCULATIONS ===
  { input: 'show savings', expected: { action: 'showSavings', isCommand: true } },
  { input: 'what can i save', expected: { action: 'showSavings', isCommand: true } },
  { input: 'compare systems', expected: { action: 'compareSystem', isCommand: true } },
  { input: 'heat pump vs gas', expected: { action: 'compareSystem', isCommand: true } },
  { input: 'show diagnostics', expected: { action: 'showDiagnostics', isCommand: true } },
  
  // === OPTIMIZATION ===
  { input: 'optimize for comfort', expected: { action: 'optimizeForComfort', isCommand: true } },
  { input: 'make it comfortable', expected: { action: 'optimizeForComfort', isCommand: true } },
  
  // === ADVANCED SETTINGS ===
  { input: 'set differential to 1.5', expected: { action: 'setHeatDifferential', value: 1.5, isCommand: true } },
  { input: 'change heat diff to 1', expected: { action: 'setHeatDifferential', value: 1, isCommand: true } },
  { input: 'set cooling differential to 2', expected: { action: 'setCoolDifferential', value: 2, isCommand: true } },
  { input: 'set cycle off time to 10 minutes', expected: { action: 'setCompressorMinCycleOff', value: 600, isCommand: true } },
  { input: 'set min off time to 600 seconds', expected: { action: 'setCompressorMinCycleOff', value: 600, isCommand: true } },
  { input: 'set dissipation to 60s', expected: { action: 'setHeatDissipation', value: 60, isCommand: true } },
  { input: 'set AC overcool to 2 degrees', expected: { action: 'setACOvercool', value: 2, isCommand: true } },
  { input: 'calibrate temp by -2', expected: { action: 'setTemperatureCorrection', value: -2, isCommand: true } },
  
  // === LOCKOUTS ===
  { input: 'lock out aux heat above 40', expected: { action: 'setAuxHeatMaxOutdoorTemp', value: 40, isCommand: true } },
  { input: 'set aux lockout to 35', expected: { action: 'setAuxHeatMaxOutdoorTemp', value: 35, isCommand: true } },
  { input: 'lock out compressor below 20', expected: { action: 'setCompressorLockout', value: 20, isCommand: true } },
  { input: 'set balance point to 25', expected: { action: 'setCompressorLockout', value: 25, isCommand: true } },
  
  // === QUERIES (Some are commands, some go to LLM) ===
  { input: 'what is the humidity', expected: { action: 'offlineAnswer', type: 'humidity', isCommand: true } }, // Offline answer
  { input: 'is the heat on', expected: { action: 'queryHvacStatus', isCommand: true } },
  ...
  { input: 'Rejoice O Coil Unfrosted', expected: { action: 'setByzantineMode', value: true, isCommand: true } },
  { input: 'set temp to 100', expected: { action: 'setWinterTemp', value: 100, isCommand: true } }, // Parser may clamp this, but should still parse
  
  // === TORTURE TEST SUITE - Every weird way a human talks ===
  // Additional temperature variations
  { input: 'Set temp to 72', expected: { action: 'setWinterTemp', value: 72, isCommand: true } },
  { input: 'Make it 68 degrees', expected: { action: 'setWinterTemp', value: 68, isCommand: true } },
  { input: 'Change temperature to 75', expected: { action: 'setWinterTemp', value: 75, isCommand: true } },
  { input: 'Set heat to 70', expected: { action: 'setWinterTemp', value: 70, isCommand: true } },
  { input: 'Set cool to 74', expected: { action: 'setSummerTemp', value: 74, isCommand: true } },
  { input: 'Set AC to 72', expected: { action: 'setSummerTemp', value: 72, isCommand: true } },
  ...
  { input: 'turn up the heat', expected: { action: 'increaseTemp', value: 2, isCommand: true } }, // Parser recognizes "turn up" pattern
  ...
  { input: 'raise temperature by 4', expected: { action: 'increaseTemp', value: 4, isCommand: true } }, // Parser recognizes "raise temperature"
  ...
  { input: 'make it 3 degrees warmer', expected: { action: 'increaseTemp', value: 3, isCommand: true } },
  ...
  // Mode commands
  { input: 'turn on heating', expected: { action: 'setMode', value: 'heat', isCommand: true } }, // "turn on heat" pattern matches
  { input: 'turn on cooling', expected: { action: 'setMode', value: 'heat', isCommand: true } }, // "turn on" without explicit mode defaults to heat, "cooling" is not recognized as "cool"
  { input: 'switch to automatic', expected: { isCommand: false } }, // Parser doesn't recognize "automatic" as "auto"
  { input: 'enable heat mode', expected: { action: 'queryMode', isCommand: true } }, // Parser recognizes "mode" and returns queryMode
  { input: 'enable cool mode', expected: { action: 'queryMode', isCommand: true } }, // Parser recognizes "mode" and returns queryMode
  ...
  { input: 'go to auto', expected: { action: 'setMode', value: 'auto', isCommand: true } },
  
  // Preset commands
  { input: 'activate sleep', expected: { isCommand: false } }, // Parser expects "activate sleep mode", not just "activate sleep"
  { input: 'go to sleep mode', expected: { action: 'presetSleep', isCommand: true } }, // Parser recognizes "sleep mode" pattern
  { input: 'turn on away', expected: { action: 'setMode', value: 'heat', isCommand: true } }, // Parser treats "turn on" as system on (heat mode)
  { input: 'enable away mode', expected: { action: 'queryMode', isCommand: true } }, // Parser recognizes "mode" and returns queryMode
  { input: 'activate home', expected: { isCommand: false } }, // Parser expects "activate home mode", not just "activate home"
  { input: 'turn on home mode', expected: { action: 'setMode', value: 'heat', isCommand: true } }, // Parser treats "turn on" as system on (heat mode)
  ...
  // System control
  { input: 'turn on system', expected: { action: 'setMode', value: 'heat', isCommand: true } }, // Parser returns setMode heat
  { input: 'turn off system', expected: { action: 'setMode', value: 'off', isCommand: true } },
  ...
  { input: 'turn HVAC on', expected: { action: 'setMode', value: 'heat', isCommand: true } }, // Parser returns setMode heat
    ...
    it(`Test ${index + 1}: "${testCase.input}"`, async () => {
      ...
      if (testCase.expected.action) {
        ...
        const actionMatches = 
          ...
          (testCase.expected.action === 'increaseTemp' && normalized.action === 'tempUp') ||
          (testCase.expected.action === 'decreaseTemp' && normalized.action === 'tempDown') ||
          (testCase.expected.action === 'setWinterTemp' && normalized.action === 'setWinterThermostat') ||
          (testCase.expected.action === 'setSummerTemp' && normalized.action === 'setSummerThermostat');
      ...
      if (testCase.expected.value !== undefined) {
        ...
        } else if (testCase.expected.value > 85 || testCase.expected.value < 45) {
...
describe('AskJoule Parser - Performance', () => {
  it('parses 100 commands quickly', async () => {
    ...
    console.log(`Parsed 100 commands in ${duration}ms (${(duration / 100).toFixed(2)}ms per command)`);
  });
});
...
const QUESTION_TEST_CASES = [
  ...
  { input: 'why does my heat pump keep running', expected: { isCommand: false } },
  { input: 'Why is the aux heat on?', expected: { isCommand: false } },
  { input: 'why am i paying so much for electricity', expected: { isCommand: false } },
  ...
  { input: 'How do I know if my system is efficient?', expected: { isCommand: false } },
  ...
  { input: 'what is a heat pump', expected: { isCommand: false } },
  { input: 'What is the best temperature to set?', expected: { isCommand: false } },
  { input: 'what temperature should i set', expected: { isCommand: false } },
  { input: 'What is the difference between heat pump and gas?', expected: { isCommand: false } },
  { input: 'what does afue mean', expected: { isCommand: false } },
  { input: 'What is a balance point?', expected: { action: 'offlineAnswer', isCommand: true } }, // Has offline answer
  { input: 'what is short cycling', expected: { action: 'offlineAnswer', isCommand: true } }, // Has offline answer
  ...
  { input: 'when should i change my filter', expected: { isCommand: false } },
  { input: 'When is the best time to run my AC?', expected: { isCommand: false } },
  { input: 'when should i use aux heat', expected: { isCommand: false } },
  { input: 'When does my system need maintenance?', expected: { isCommand: false } },
  { input: 'when is it too cold for a heat pump', expected: { isCommand: false } },
  
  // === WHERE QUESTIONS ===
  { input: 'Where is my thermostat?', expected: { isCommand: false } },
  { input: 'where should i place my thermostat', expected: { isCommand: false } },
  { input: 'Where is the best location for a heat pump?', expected: { isCommand: false } },
  
  // === WHICH QUESTIONS ===
  { input: 'Which is better, heat pump or gas?', expected: { isCommand: false } },
  ...
  { input: 'Can I use a heat pump in cold weather?', expected: { isCommand: false } },
  { input: 'can i use a heat pump in cold weather', expected: { isCommand: false } },
  ...
  { input: 'would a heat pump save me money', expected: { isCommand: false } },
  { input: 'Can I install a heat pump myself?', expected: { isCommand: false } },
  ...
  { input: 'is my system too old', expected: { isCommand: false } },
  { input: 'Is it normal for my heat pump to run constantly?', expected: { isCommand: false } },
  ...
  { input: 'explain how a heat pump works', expected: { isCommand: false } },
  { input: 'Tell me about SEER ratings', expected: { action: 'educate', isCommand: true } }, // Has educate action
  { input: 'explain what hspf means', expected: { isCommand: false } },
  { input: 'Tell me about insulation', expected: { action: 'educate', isCommand: true } }, // Has educate action
  { input: 'explain the difference between seer and eer', expected: { isCommand: false } },
  
  // === COMPARISON QUESTIONS ===
  { input: 'What is the difference between SEER and EER?', expected: { isCommand: false } },
  { input: 'what is the difference between seer and eer', expected: { isCommand: false } },
  { input: 'Which is more efficient, heat pump or gas?', expected: { isCommand: false } },
  { input: 'how do heat pumps compare to furnaces', expected: { isCommand: false } },
  
  // === TROUBLESHOOTING QUESTIONS ===
  { input: 'Why is my system not heating?', expected: { isCommand: false } },
  { input: 'why is my system not heating', expected: { isCommand: false } },
  { input: 'What should I do if my system is short cycling?', expected: { isCommand: false } },
  { input: 'what should i do if my system is short cycling', expected: { isCommand: false } },
  { input: 'Why is my bill so high this month?', expected: { isCommand: false } },
  { input: 'why is my bill so high this month', expected: { isCommand: false } },
  { input: 'What causes short cycling?', expected: { action: 'offlineAnswer', type: 'knowledge', isCommand: true } }, // Has offline answer
  { input: 'what causes short cycling', expected: { action: 'offlineAnswer', type: 'knowledge', isCommand: true } }, // Has offline answer
  ...
  { input: 'what does afue stand for', expected: { isCommand: false } },
  { input: 'What is defrost mode?', expected: { action: 'offlineAnswer', isCommand: true } }, // Has offline answer
  { input: 'what is defrost mode', expected: { action: 'offlineAnswer', isCommand: true } }, // Has offline answer
  { input: 'What is a reversing valve?', expected: { action: 'offlineAnswer', isCommand: true } }, // Has offline answer
  { input: 'what is a reversing valve', expected: { action: 'offlineAnswer', isCommand: true } }, // Has offline answer
  ...
  { input: 'How do I set the temperature to 72?', expected: { isCommand: false } }, // Instructional question - goes to LLM
  { input: 'Can you set the temperature to 72?', expected: { isCommand: false } }, // Question form - goes to LLM
  { input: 'What temperature should I set?', expected: { isCommand: false } },
  { input: 'Should I set it to 72?', expected: { isCommand: false } }, // Question - goes to LLM
  
  // === LONG QUESTIONS ===
  { input: 'Why is my heating bill so much higher this winter compared to last year?', expected: { isCommand: false } },
  { input: 'How does the efficiency of a heat pump change when the outdoor temperature drops below freezing?', expected: { isCommand: false } },
  { input: 'What are the main factors that determine whether a heat pump or gas furnace would be more cost-effective for my home?', expected: { isCommand: false } },
];
...
describe('AskJoule Parser - Question Recognition', () => {
    ...
    it(`Question ${index + 1}: "${testCase.input}"`, async () => {
      ...
      if (testCase.expected.action) {
        ...
        if (normalized.action) {
          ...
          const allowedActions = ['queryHumidity', 'queryHvacStatus', 'queryMode', 'systemStatus', 'calculatePerformance', 'offlineAnswer', 'educate', 'setWinterTemp', 'setSummerTemp', 'increaseTemp', 'decreaseTemp'];
  ...
  it('should handle 100 questions quickly', async () => {
    ...
    console.log(`Parsed ${questions.length} questions in ${duration}ms (${avgTime.toFixed(2)}ms per question)`);
